...
export class AutoMigration1763222627818 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(`CREATE TABLE "user_plan_executions" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "version" varchar NOT NULL, "plan" varchar NOT NULL, "planDay" integer NOT NULL, "currentTime" datetime NOT NULL DEFAULT (datetime('now')), "userId" integer NOT NULL)`);
    await queryRunner.query(`CREATE INDEX "IDX_10333056cba1883a03baef673a" ON "user_plan_executions" ("userId") `);
    await queryRunner.query(`CREATE TABLE "users" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "groupName" varchar(120) NOT NULL, "welcomeText" varchar(500) NOT NULL, "plan" varchar NOT NULL, "version" varchar NOT NULL, "startDate" date NOT NULL, "scheduleTime" time NOT NULL, "groupId" varchar(50))`);
    await queryRunner.query(`DROP INDEX "IDX_10333056cba1883a03baef673a"`);
    await queryRunner.query(`CREATE TABLE "temporary_user_plan_executions" ("id" integer PRIMARY KEY AUTOINCREMENT NOT NULL, "version" varchar NOT NULL, "plan" varchar NOT NULL, "planDay" integer NOT NULL, "currentTime" datetime NOT NULL DEFAULT (datetime('now')), "userId" integer NOT NULL, CONSTRAINT "FK_10333056cba1883a03baef673ae" FOREIGN KEY ("userId") REFERENCES "users" ("id") ON DELETE CASCADE ON UPDATE CASCADE)`);
